...
"[project]/client/pages/books/[id].jsx [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BookDetailPage() {
    ...
    const [book, setBook] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BookDetailPage.useEffect": ()=>{
            ...
            fetch(`http://localhost:5000/api/books/${id}`).then({
                "BookDetailPage.useEffect": (res)=>{
                    if (!res.ok) throw new Error("Not Found");
                    return res.json();
                }
            }["BookDetailPage.useEffect"]).then({
                "BookDetailPage.useEffect": (data)=>setBook(data)
            }["BookDetailPage.useEffect"]).catch({
                "BookDetailPage.useEffect": (err)=>{
    ...
    if (!book) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(BookDetailPage, "gpuj+feil/x+ZrlQjcHv41pwDL8=", false, function() {
    return [
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/client/pages/books/[id].jsx [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/books/[id]";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/client/pages/books/[id].jsx [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/client/pages/books/[id].jsx\" }", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/client/pages/books/[id].jsx [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__0t10t77._.js.map